...
function createEntryStore()
{
	...
	store.addEntry(new Entry("Neue Version 2.0 Beta7 wurde veröffentlicht", new Date("2011,08,12"), "Die KACE-Integration ist jetzt verfügbar und kann aktiviert werden.SyncManager Performance der Geräte-Tabelle mit vielen Geräten signifikant verbessert"));
